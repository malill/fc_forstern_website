...
<?php $hidelogoright = of_get_option('hidelogoright', '1'); ?>
<?php if($hidelogoright == ''){ ?>                    
    <div class="header_right"> 
		<?php if( of_get_option('headerinfobutton',true) != ''){ ?>
            <div class="header-infobox">
                 <?php if( of_get_option('headerinfobutton') != '') { echo do_shortcode(of_get_option('headerinfobutton')); } ; ?>
            </div>
        <?php } ?>
