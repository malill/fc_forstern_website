...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'sports-club' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'sports-club' ),
		'repeat-y'  => __( 'Repeat Vertically', 'sports-club' ),
		'repeat'    => __( 'Repeat All', 'sports-club' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'sports-club' ),
		'top center'    => __( 'Top Center', 'sports-club' ),
		'top right'     => __( 'Top Right', 'sports-club' ),
		'center left'   => __( 'Middle Left', 'sports-club' ),
		'center center' => __( 'Middle Center', 'sports-club' ),
		'center right'  => __( 'Middle Right', 'sports-club' ),
		'bottom left'   => __( 'Bottom Left', 'sports-club' ),
		'bottom center' => __( 'Bottom Center', 'sports-club' ),
		'bottom right'  => __( 'Bottom Right', 'sports-club')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'sports-club' ),
		'fixed'  => __( 'Fixed in Place', 'sports-club')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'sports-club' ),
		'italic'      => __( 'Italic', 'sports-club' ),
		'bold'        => __( 'Bold', 'sports-club' ),
		'bold italic' => __( 'Bold Italic', 'sports-club' )
		);
